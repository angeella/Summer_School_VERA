...
We can for example highlight a path in the network, the shortest path from a vertex with Left account category to a vertex with Right account category.
...
Lets try to improve it, we want nodes having **size** that reflects the *centrality betweeneess* measure.
